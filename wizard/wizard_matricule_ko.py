...
class WizardMatriculeKo(models.TransientModel):
    _name = 'wizard.matricule.ko'
    ...
    def action_matricule_ko(self):
        lines = []
        matricule_ok = self.env["fiche.matricule.ko"].search([])
        ...
        return self.env.ref('gestion_center_imputation.report_matricule_ko_views_action').report_action(self, data=data)
