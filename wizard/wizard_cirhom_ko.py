...
class WizardCirhomKo(models.TransientModel):
    _name = 'wizard.cirhom.ko'
    ...
    def action_cirhom_ko(self):
        lines = []
        cirhom_ok = self.env["fiche.cirhom.ko"].search([])
        ...
        return self.env.ref('gestion_center_imputation.report_cirhom_ko_views_action').report_action(self, data=data)
